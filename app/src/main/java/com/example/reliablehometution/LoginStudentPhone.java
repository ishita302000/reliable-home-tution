...
public class LoginStudentPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_student_phone);

        btn_phn_login=findViewById(R.id.login_phn_student);
        final EditText mPhone_no=findViewById(R.id.phn__login_student);
        mOTP_no=findViewById(R.id.loginotp_student);
                ...
                if(!verificationInprogress) {
                   ...
                   // reLogin_otp_not_generated.setVisibility(View.VISIBLE);
                    ...
                    if(!userOTP.isEmpty() && userOTP.length()==6){
                       ...
                       // startActivity(new Intent(LoginStudentPhone.this,form_teacher.class));
    ...
    public void requestOTP(String phonNo){
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phonNo, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(LoginStudentPhone.this,"Cannot create account"+e.getMessage(),Toast.LENGTH_SHORT).show();
                Toast.makeText(LoginStudentPhone.this,"please try after sometime."+e.getMessage(),Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
                startActivity(new Intent(LoginStudentPhone.this,MainActivity.class));
            }
        });
        ...
        fAuth1.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(LoginStudentPhone.this,"Login successful",Toast.LENGTH_SHORT).show();
                    DocumentReference documentReference = fstore1.collection("STUDENT").document(fAuth1.getCurrentUser().getUid());
                        ...
                        fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(LoginStudentPhone.this,"noDeleted not",Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }else{
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if(documentSnapshot.exists()){
                                    progressBar.setVisibility(View.GONE);
                                    startActivity(new Intent(LoginStudentPhone.this,personal_details_student.class));
                                    //Toast.makeText(phn_teacher.this,"Authentication is successful123",Toast.LENGTH_SHORT).show();
                                }
                                else{
                                    Toast.makeText(LoginStudentPhone.this,"userDoesnotExist",Toast.LENGTH_SHORT).show();
                                    fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                    ...
                    //reLogin_otp_not_generated.setVisibility(View.GONE);
                    Toast.makeText(LoginStudentPhone.this,"wrong OTP entered",Toast.LENGTH_SHORT).show();
                    Toast.makeText(LoginStudentPhone.this,"relogin with phone no",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LoginStudentPhone.this,LoginTeacherPhone.class));
                }
            }
        });
    }
