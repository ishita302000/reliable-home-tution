...
public class form_student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity( new Intent(form_student.this,personal_details_student.class));
                finish();
            }
        });
    ...
    private void uploadImagetoFirebase(String name, Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(form_student.this,"Image is uploaded",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener( (e)->{
            Toast.makeText(form_student.this,"Upload Failed",Toast.LENGTH_SHORT).show();
        });
    }
