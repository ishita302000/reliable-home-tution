    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next_qua_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference documentReference = fstore.collection("TEACHER_QUALIFICATION").document(userId_techer);
                ...
                documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        //startActivity(i);
                        Toast.makeText(qualification_teacher.this , "ThankYou for filling the form " , Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(qualification_teacher.this,LOGOUTforParent.class));
