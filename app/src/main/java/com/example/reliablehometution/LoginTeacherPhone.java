...
public class LoginTeacherPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_teacher_phone);
    ...
    public void requestOTP(String phonNo){
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phonNo, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(LoginTeacherPhone.this,"Cannot create account"+e.getMessage(),Toast.LENGTH_SHORT).show();
                Toast.makeText(LoginTeacherPhone.this,"please try after sometime."+e.getMessage(),Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
                startActivity(new Intent(LoginTeacherPhone.this,MainActivity.class));
            }
        });
        ...
        fAuth1.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(LoginTeacherPhone.this,"Login successful",Toast.LENGTH_SHORT).show();
                    DocumentReference documentReference = fstore1.collection("TEACHER").document(fAuth1.getCurrentUser().getUid());
                        ...
                        fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(LoginTeacherPhone.this,"noDeleted not",Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }else{
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if(documentSnapshot.exists()){
                                    ...
                                    Toast.makeText(LoginTeacherPhone.this,"userDoesnotExist",Toast.LENGTH_SHORT).show();
                                    fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                   ...
                   // reLogin_otp_not_generated.setVisibility(View.GONE);
                    Toast.makeText(LoginTeacherPhone.this,"wrong OTP entered",Toast.LENGTH_SHORT).show();
                    Toast.makeText(LoginTeacherPhone.this,"relogin with phone no",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LoginTeacherPhone.this,LoginTeacherPhone.class));
                }
            }
        });
    }
