...
public class SignUpParent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacher_regName = findViewById(R.id.signn_fullname_parent);
        //teacher_regUsserName = findViewById(R.id.signn_username_teacher);
        teacher_regEmail = findViewById(R.id.sign_email_parent);
        teacher_Phone = findViewById(R.id.sign_phn_parent);
        teacher_regpassword = findViewById(R.id.sign_password_parent);
        teacher_regbtn = findViewById(R.id.signup_parent);
        teacher_regtoLoginBtn = findViewById(R.id.Login_text_sigin_parent);
        enterotp = findViewById(R.id.sign_otp_parent);
        progressBar = findViewById(R.id.progressBar_parent_signup);
        ...
        if (fAuth.getCurrentUser() != null) {
            startActivity(new Intent(getApplicationContext(), LoginPageParent.class));
            finish();
        }
        teacher_regtoLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SignUpParent.this,LoginPageParent.class));
            }
        });
                    ...
                    fAuth.createUserWithEmailAndPassword(teacher_email, teacher_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                DocumentReference documentReference = fstore.collection("PARENT").document(userId_techer);
                                ...
                                Toast.makeText(SignUpParent.this, "Error !" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void requestOTP(String phonNo) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phonNo, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                Toast.makeText(SignUpParent.this, "Cannot create account" + e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                fAuth2.signInWithEmailAndPassword(teacher_regEmail .getEditableText().toString(),teacher_regpassword.getEditableText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            FirebaseFirestore.getInstance().collection("PARENT").document(userId_techer1).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(SignUpParent.this,"Error",Toast.LENGTH_SHORT).show();
                                }
                            });
                            fUser=fAuth2.getCurrentUser();
                            fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(SignUpParent.this,"Signup again after sometimes.",Toast.LENGTH_SHORT).show();
                                        FirebaseAuth.getInstance().signOut();
                                    }
                                    else{
    ...
    private void verifyAuth(PhoneAuthCredential credential) {
        fAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(SignUpParent.this, "registration is sucessful", Toast.LENGTH_SHORT).show();
                    userId1 = fAuth1.getCurrentUser().getUid();
                    DocumentReference documentReference1 = fstore1.collection("PARENT").document(userId1);
                    ...
                    Toast.makeText(SignUpParent.this, "registration failed", Toast.LENGTH_SHORT).show();
                    // teacher_regbtn.setEnabled(true);
                    ...
                    fAuth3.signInWithEmailAndPassword(teacher_regEmail .getEditableText().toString(),teacher_regpassword.getEditableText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                FirebaseFirestore.getInstance().collection("PARENT").document(userId_techer3).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        // Toast.makeText(Signup_teacher.this,"Deleted Successfuly",Toast.LENGTH_SHORT).show();
                                    }
    ...
    public void logout(){
        FirebaseAuth.getInstance().signOut();
        Toast.makeText(SignUpParent.this,"authentication failed", Toast.LENGTH_SHORT).show();
        finish();
    }
