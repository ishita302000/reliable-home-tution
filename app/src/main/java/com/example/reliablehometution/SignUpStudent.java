...
public class SignUpStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_phone = findViewById(R.id.sign_phn_student);
        student_regpassword = findViewById(R.id.sign_password_student);
        progressBar=findViewById(R.id.progressBar_student_signup);
        student_regbtn = findViewById(R.id.signup_student);
        ...
        student_regtoLoginBtn .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SignUpStudent.this,LoginPageTeacher.class));
            }
        });
        ...
        student_regbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (u == 0) {
                    ...
                    student_regbtn.setEnabled(false);
                    progressBar.setVisibility(View.VISIBLE);
                    student_regtoLoginBtn.setVisibility(View.GONE);
                    ...
                    fAuth.createUserWithEmailAndPassword(teacher_email, teacher_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                DocumentReference documentReference = fstore.collection("STUDENT").document(userId_techer);
                                ...
                                Toast.makeText(SignUpStudent.this, "Error !" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                // mProgressBar2.setVisibility(View.GONE);u=
                                progressBar.setVisibility(View.INVISIBLE);
                                student_regbtn.setEnabled(true);
                                student_regtoLoginBtn.setVisibility(View.VISIBLE);
                                u = 0;
                            }
                        }
    ...
    public void requestOTP(String phonNo) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phonNo, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                Toast.makeText(SignUpStudent.this, "Cannot create account" + e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                fAuth2.signInWithEmailAndPassword(student_regEmail .getEditableText().toString(),student_regpassword.getEditableText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            FirebaseFirestore.getInstance().collection("STUDENT").document(userId_techer1).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                            ...
                            fUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(SignUpStudent.this,"Signup again after sometimes.",Toast.LENGTH_SHORT).show();
                                        FirebaseAuth.getInstance().signOut();
                                    }
                                    else{
    ...
    private void verifyAuth(PhoneAuthCredential credential) {
        fAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(SignUpStudent.this, "registration is sucessful", Toast.LENGTH_SHORT).show();
                    userId1 = fAuth1.getCurrentUser().getUid();
                    DocumentReference documentReference1 = fstore1.collection("STUDENT").document(userId1);
                    ...
                    Toast.makeText(SignUpStudent.this, "registration failed", Toast.LENGTH_SHORT).show();
                    ...
                    fAuth3.signInWithEmailAndPassword(student_regEmail .getEditableText().toString(),student_regpassword.getEditableText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                FirebaseFirestore.getInstance().collection("STUDENT").document(userId_techer3).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        //Toast.makeText(Signup_student.this,"Deleted Successfuly",Toast.LENGTH_SHORT).show();
                                    }
